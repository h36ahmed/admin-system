...
var manageOrderCtrl = function($scope, orderService, modalService) {
  ...
  function getOffers(options) {
    options.order_date = formatDate(options.order_date);
...
manageOrderCtrl.inject = ['$scope', 'orderService', 'modalService'];
